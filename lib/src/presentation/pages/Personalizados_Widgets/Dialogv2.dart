...
class DialogV2 extends StatelessWidget {
  /// Creates a dialog.
  ///
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedPadding(
      padding: MediaQuery.of(context).viewInsets + const EdgeInsets.symmetric(horizontal: 30.0, vertical: 15.0),
...
class AlertDialogV2 extends StatelessWidget {
