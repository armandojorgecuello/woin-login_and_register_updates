                                                                        ...
                                                                        children: <
                                                                          ...
                                                                          Flexible(
                                                                            child:
                                                                              ...
                                                                              style: TextStyle(color: doc != null && doc.id == snapshot.data[index].id ? Color(0xff1ba6d2) : Color(0xffb7b7b7), fontWeight: FontWeight.w400, fontFamily: "TrebuchetMS", fontSize: snapshot.data[index].name.length > 15 ? heightc * 0.022 : heightc * 0.025),
                                                                            ),
                                                                          ),
                                                                        ],
                                                                      ),
