                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text('Articulos que me gustan',
                          style: TextStyle(
                              fontSize: screenSize.width * 0.035,
                              fontWeight: FontWeight.w700,
                              color: Colors.grey[800])),
                      SizedBox(height: screenSize.width * 0.001)
                    ],
                  ),
                ),
                Expanded(
                 child: ListView.builder(
                      itemCount: 7,
                      itemBuilder: (Context, int index) => ItemFavorite()),
                )
              ],
            )
          ),
    ...
    return Stack(
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(
              color: Colors.white,
              boxShadow: [BoxShadow(blurRadius: 5.0, color: Colors.grey[400])]),
          child: Column(
        ...
        Positioned(
            ...
            child: Icon(Icons.favorite_border,
                color: Colors.red[300], size: screenSize.height * 0.03)),
        Positioned(
            bottom: 10.0,
            right: 15.0,
            child: Icon(
