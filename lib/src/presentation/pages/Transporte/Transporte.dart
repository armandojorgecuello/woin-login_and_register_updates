    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Expanded(
            flex: 10,
            child: option==1? Mapa() :TransporteDirections(),
          )
...
class TransporteDirections extends StatefulWidget {
  @override
  _TransporteDirectionsState createState() => _TransporteDirectionsState();
}

class _TransporteDirectionsState extends State<TransporteDirections> {
